 ...
 * @description :提交报告页面
 */
public class enter_polling_report_3_fragment extends BaseFragment {
    ...
    public static enter_polling_report_3_fragment newInstance() {
        enter_polling_report_3_fragment fragment = new enter_polling_report_3_fragment();
    ...
    protected int getLayoutId() {
        return R.layout.enter_polling_report_3_fragment_layout;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_next_id:
                ...
                ((enterPollingReportActivity) getActivity()).upload();
                break;
