 ...
 * @description :
 */
public class enter_polling_report_2_fragment extends BaseFragment {
    ...
    public static enter_polling_report_2_fragment newInstance() {
        enter_polling_report_2_fragment fragment = new enter_polling_report_2_fragment();
    ...
    protected void initData() {
        ...
        templateCode= "inspection";//巡检模板Code码
        try {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_next_id:
                save();
                start(enter_polling_report_3_fragment.newInstance());
                break;
        }
    }
