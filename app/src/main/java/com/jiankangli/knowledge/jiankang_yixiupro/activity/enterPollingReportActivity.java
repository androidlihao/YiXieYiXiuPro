 ...
 * @description :录入巡检报告，用单Activity多fragment来做这个功能
 */
public class enterPollingReportActivity extends BaseActivity {
    ...
    private void initFragment() {
        if (findFragment(enter_polling_report_1_fragment.class) == null) {
            // 加载根Fragment
            loadRootFragment(R.id.fl_content, enter_polling_report_1_fragment.newInstance());
            //全局改变Fragment的动画
    ...
    public void upload() {
        DialogUtil.showPositiveDialog(this, "提示", "是否提交", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                saveInspectionOrderBean();
            }
        });
    }

    public void saveInspectionOrderBean() {
