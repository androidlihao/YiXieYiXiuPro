 ...
 * @description :
 */
public class RecordAadpter extends BaseQuickAdapter<fixRecordBean.ServiceRecodeVosBean, BaseViewHolder> {

    public RecordAadpter(int layoutResId, @Nullable List<fixRecordBean.ServiceRecodeVosBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(final BaseViewHolder helper, final fixRecordBean.ServiceRecodeVosBean item) {
